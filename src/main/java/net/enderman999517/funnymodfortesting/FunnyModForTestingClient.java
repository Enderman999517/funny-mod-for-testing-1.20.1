...
import net.enderman999517.funnymodfortesting.entity.client.*;
...
public class FunnyModForTestingClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ModModelLayers.HIDDEN, HiddenModel::getTexturedModelData);
        EntityRendererRegistry.register(ModEntities.HIDDEN, HiddenRenderer::new);
